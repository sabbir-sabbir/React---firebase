    ...
    <>
      <div className="w-full h-14 bg-gray-800 text-white flex justify-between items-center gap-12 md:gap-24 px-10 ">
        ...
        <div className="flex   gap-2 md:gap-6 ">
          <Link to="/auth/login" className="flex  items-center gap-1"> <span><img className="w-5 h-5 bg-white rounded-full"  src={login} alt="" /></span>Login</Link>
          <Link to="/auth/register" className="flex  items-center gap-1"><span><img className="w-5 h-5 bg-white rounded-sm"  src={register} alt="" /></span>Register</Link>
        </div>
      </div>
    </>
  );
